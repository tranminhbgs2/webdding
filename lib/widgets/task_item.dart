      ...
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            ...
            builder: (context) =>
                WorkScheduleDetailScreen(workSchedule: workSchedule),
          ),
        );
      },
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            "Photo: ${workSchedule.designer.name} - ${workSchedule.designer.phoneNumber}",
                            style: const TextStyle(
                              fontFamily: 'Inter',
                              color: Color(0xFF090F13),
                              fontWeight: FontWeight.normal,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              "CSKH: ${workSchedule.cskh.name} - ${workSchedule.cskh.phoneNumber}",
                              style: const TextStyle(
                                fontFamily: 'Inter',
                                color: Color(0xFF090F13),
                                fontWeight: FontWeight.normal,
