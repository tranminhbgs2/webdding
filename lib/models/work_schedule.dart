...
class WorkSchedule {
  ...
  final List<Location> locations =
    ...
    return WorkSchedule(
      ...
      packagePrice: json['packagePrice'] as double? ?? 0.0,
      makeupPrice: json['makeupPrice'] as double? ?? 0.0,
      designerPrice: json['designerPrice'] as double? ?? 0.0,
      photographerPrice: json['photographerPrice'] as double? ?? 0.0,
